...
function sort2(mode = 0) {
    switch (mode) {
        case 0:
            memory.sort((a, b) => b[0].innerText.localeCompare(a[0].innerText))
            break;
        case 1:
            memory.sort((a, b) => b[1].innerText.localeCompare(a[1].innerText))
            break;
        case 2:
            memory.sort((a, b) => Number.parseFloat(b[2].innerText) - Number.parseFloat(a[2].innerText))
            break;
        default:
            break;
    }
